...
namespace MapControl
{
    ...
    public partial class MapPanel : PanelBase, IMapElement
    {
        ...
        public MapBase ParentMap
        {
            ...
            set { this.SetParentMapOverride(value); }
        }

        protected virtual void SetParentMapOverride(MapBase map)
        {
            if (this.parentMap != null && this.parentMap != this)
            {
                this.parentMap.ViewportChanged -= this.OnViewportChanged;
            }
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            foreach (UIElement element in this.Children)
            {
                ...
                if (location != null)
                {
                    ...
                    SetViewportPosition(element, this.parentMap, location);
                }
                else
                {
        ...
        private static void SetViewportPosition(UIElement element, MapBase parentMap, Location location)
        {
            ...
            if (parentMap != null && location != null)
            {
                ...
                viewportPosition = parentMap.ViewportTransform.Transform(new Point(mapPosition.X, mapPosition.Y));

                var useLayoutRounding = element.GetValue(UseLayoutRoundingProperty);
