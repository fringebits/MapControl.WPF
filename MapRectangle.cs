    ...
    public partial class MapRectangle : MapPath
    {
        ...
        protected override void UpdateData()
        {
            if (boundingBoxValid)
            {
                ...
                {
                    var rect = new Rect(ParentMap.MapTransform.Transform(new Location(South, West)).ToSystemPoint(),
                                        ParentMap.MapTransform.Transform(new Location(North, East)).ToSystemPoint());
